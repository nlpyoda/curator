...
const VisualSearch = ({ visible, onClose, onSearch }) => {
    ...
    try {
      ...
      const enhancedResults = allResults.map((product, index) => {
        ...
        return {
          ...
          matchReason: `${Math.round(similarityScore * 100)}% visual similarity`
        };
      });
  ...
  const tryDemo = () => {
    setSelectedImage('https://images.unsplash.com/photo-1531297484001-80022131f5a1?w=600&auto=format');
    setAnalyzeStage('analyzing');
  ...
  const handleViewAllResults = () => {
    onClose();
    if (onSearch && visualSearchResults.length > 0) {
  ...
  return (
    <View style={styles.rightSidePanel}>
      ...
      <View style={styles.rightPanelContent}>
        ...
        <View style={styles.visualSearchPanelList}>
          {analyzeStage === 'initial' ? (
            /* Upload Interface */
            <View style={styles.visualSearchUploadContainer}>
              <View style={styles.visualSearchUploadArea}>
                <View style={styles.visualSearchUploadIcon}>
                  <Text style={styles.visualSearchIconText}>📸</Text>
                </View>
                <Text style={styles.visualSearchUploadTitle}>
                  Drag & drop an image
                </Text>
                <Text style={styles.visualSearchUploadSubtitle}>
                  or choose from your device
                </Text>
                
                <View style={styles.visualSearchButtonGroup}>
                  <TouchableOpacity 
                    style={styles.visualSearchPrimaryButton}
                    onPress={selectImage}
                  >
                    <Text style={styles.visualSearchPrimaryButtonText}>Browse Files</Text>
                  </TouchableOpacity>
                  
                  <TouchableOpacity 
                    style={styles.visualSearchSecondaryButton}
                    onPress={tryDemo}
                  >
                    <Text style={styles.visualSearchSecondaryButtonText}>Try Demo</Text>
                  </TouchableOpacity>
                </View>
                
                <Text style={styles.visualSearchHelpText}>
                  Supports JPG, PNG up to 10MB
                </Text>
                
                {error && (
                  <Text style={styles.visualSearchErrorText}>{error}</Text>
                )}
            ...
            <View style={styles.visualSearchAnalyzing}>
              {selectedImage && (
                <View style={styles.visualSearchImagePreview}>
                  <Image 
                    source={{ uri: selectedImage }} 
                    style={styles.visualSearchPreviewImage} 
                    resizeMode="cover" 
                  />
                </View>
              )}
            ...
            <View style={styles.modernVisualSearchResults}>
              ...
              <TouchableOpacity 
                ...
                onPress={() => {
                  // Close modal and show all visual search results in main area
